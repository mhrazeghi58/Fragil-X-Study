# -*- coding: utf-8 -*-
"""
Created on Tue Jul  1 11:09:50 2025
...
for fname in sorted(os.listdir(input_dir)):
    ...
    # --- t-SNE & clustering ---
    tsne_result = TSNE(n_components=3, perplexity=100, random_state=10).fit_transform(flat_features)
    n_clusters = 8
    kmeans = KMeans(n_clusters=n_clusters, random_state=10).fit(tsne_result)
    ...
    plt.figure(figsize=(8, 6))
    plt.scatter(tsne_result[:, 0], tsne_result[:, 1], c=cluster_labels, cmap='tab10', s=0.5, alpha=0.4)
